<table class="table table-striped">
    ...
    @foreach($todos as $todo)
        <tr>
            ...
            <td>
                <form method="POST" action="{{url('/avatars', [$todo->id])}}" enctype="multipart/form-data">
                    {{csrf_field()}}
            ...
            <td>
                <a href="/edit/{{$todo->id}}">
                    <button class="btn btn-info">Edit Task <span class="glyphicon glyphicon-edit"></span></button>
                </a>
            </td>
